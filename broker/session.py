...
def make_session(settings_obj=None, **kwargs):
    ...
    try:
        ...
        return session_cls(settings_obj=_settings, **kwargs)
        ...
        return DummySession(settings_obj=_settings, **kwargs)


def get_interactive_shell(settings_obj=None):
...
class ContainerSession:
    ...
    def __init__(self, cont_inst, runtime=None, settings_obj=None):
